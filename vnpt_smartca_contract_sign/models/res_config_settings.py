...
class ResConfigSettings(models.TransientModel):
    ...
    smartca_timeout = fields.Integer(string="SmartCA Timeout (s)", config_parameter="vnpt_smartca.timeout", default=30)

    smartca_poll_limit = fields.Integer(string="Poll batch size", config_parameter="vnpt_smartca.poll_limit", default=50)